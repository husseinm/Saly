...
soviControllers.controller('AdminModelEditor', ['$scope', 
  function($scope) {
    $scope.empty = "empty";
  }]);

soviControllers.controller('AdminScriptEditor', ['$scope',
  function($scope) {
    /*
     * Setup
     */
...
soviControllers.controller('AdminPreferences', ['$scope', 
  function($scope) {
    $scope.empty = "empty";
  }]);

soviControllers.controller('AdminReportViewer', ['$scope', 
  function($scope) {
    $scope.empty = "empty";
  }]);
